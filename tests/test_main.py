...
import pytest
from src.main import Category, Product, Smartphone, LawnGrass, Order, BaseProduct
...
def test_log_mixin(capsys):
    product = Product("Test Product", "Описание", 1000.0, 10)
    captured = capsys.readouterr()
    assert "Создан объект класса Product" in captured.out
    assert "args=('Test Product', 'Описание', 1000.0, 10)" in captured.out
